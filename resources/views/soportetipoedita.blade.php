...
<body>
  ...
  <!--|====| Container | ↓ | → | inicio |====|--><div class="container">
    <!--|==========| Bienvenida | ↓ |==========|-->
    <h1 id="greeting">Editar Tipo de Soporte</h1>
    
    <!--|==========| Formulario | ↓ | inicio |==========|-->
    <form action="{{url('/st/update/')}}" method="post">
      @csrf
      <input type="hidden" class="form-control form-control-lg" name="ii" value="@php echo $ii; @endphp" autocomplete="off" required>
      <label class="lblformuser">Nombre</label>
      <input type="text" class="form-control form-control-lg" name="txtEditSoporte" value="@php echo $name; @endphp" autocomplete="off" required>
